      ...
      <div className='flex flex-col items-center justify-center'>
          <h1 className="flex justify-center text-5xl py-20 text-[#F8EE4F]">Culture Quizz</h1>
              ...
              <div className="flex justify-center">
                  <button type="button" onClick={handleBackSettings} className="focus:outline-none mt-5 text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Play again !</button>
               </div>
      </div>
     </div> 
    );
